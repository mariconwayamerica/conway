---
description: "Odoo data declaration - master data vs demo data, CSV/XML data files, manifest configuration, external identifiers"
applyTo: "**/__manifest__.py,**/data/**/*.xml,**/data/**/*.csv,**/demo/**/*.xml"
---
