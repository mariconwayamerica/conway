---
description: "Odoo computed fields with @api.depends decorator, inverse functions, onchange methods, and performance considerations for field dependencies"
applyTo: "**/models/**/*.py"
---
...
Reference: the documentation related to this topic can be found in [Computed Fields](https://www.odoo.com/documentation/19.0/developer/reference/backend/orm.html#reference-orm-fields-compute).
...
Many examples of computed fields can be found in Odoo. Here is a [simple one](https://github.com/odoo/odoo/blob/cd9af815ba591935cda367d33a1d090f248dd18d/addons/crm/models/crm_lead.py#L200-L205).
...
The example is given with a `Many2one`, but it is valid for `Many2many` or a `One2many`. An example can be found [here](https://github.com/odoo/odoo/blob/cd9af815ba591935cda367d33a1d090f248dd18d/addons/crm/models/crm_lead.py#L154-L161).
...
**Tip**: you might want to try using the `mapped()` method. See [here](https://github.com/odoo/odoo/blob/cd9af815ba591935cda367d33a1d090f248dd18d/addons/event/models/event_event.py#L276) for a simple example.
...
An example can be found [here](https://github.com/odoo/odoo/blob/cd9af815ba591935cda367d33a1d090f248dd18d/addons/event/models/event_event.py#L122-L128).
...
Reference: the documentation related to this topic can be found in [onchange()](https://www.odoo.com/documentation/19.0/developer/reference/backend/orm.html#odoo.api.onchange):

📝 **Note**: **Goal**: at the end of this section, enabling the garden will set a default area of 10 and an orientation to North.
...
Onchanges methods can also return a non-blocking warning message ([example](https://github.com/odoo/odoo/blob/cd9af815ba591935cda367d33a1d090f248dd18d/addons/payment/models/payment_transaction.py#L362-L381)).
