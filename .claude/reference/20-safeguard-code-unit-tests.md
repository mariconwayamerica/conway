---
description: "Odoo unit testing - test case classes, setUp/tearDown methods, assertions, test data creation, running tests with --test-enable"
applyTo: "**/tests/**/*.py,**/__manifest__.py"
---
