---
description: "Creating SQL views for custom reports - models.Model with _auto=False, custom SQL queries, reporting models, BI integration"
applyTo: "**/report/**/*.py,**/views/**/*.xml"
---
