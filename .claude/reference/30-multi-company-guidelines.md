---
description: "Multi-company architecture in Odoo - company_id fields, security rules, data isolation, allowed_company_ids context"
applyTo: "**/models/**/*.py,**/security/**/*.xml,**/security/**/*.csv"
---
